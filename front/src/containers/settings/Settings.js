        ...
        return (
            <div className="settings-wrapper">
                <div className="settings-box"style={{girdRow:"1"}}>
                        ...
                        <button id="pathToExe" className="formin-wide">modificar</button>
                    </div>
                ...
                <label htmlFor="lang-box"
                    ...
                    <button id="lang" className="formin-wide">guardar</button>
                </div>
                ...
                //TODO: adicionar fetch para tomar os dados do csv online
                    ...
                    <button id="logDir" className="formin-wide">modificar</button>
                </div>
                ...
                <label htmlFor="logged"
                    ...
                    <button id="logStandard" className="formin-wide" >modificar</button>
                </div>
            </div>
        )
    }
